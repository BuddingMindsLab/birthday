...
async function experimentInit() {
  ...
  image = new visual.ImageStim({
    ...
    image : 'instructions1b.png', mask : undefined,
  ...
  image_2 = new visual.ImageStim({
    ...
    image : 'instructions2.png', mask : undefined,
  ...
  base_image = new visual.ImageStim({
    ...
    image : 'creatures/base.png', mask : undefined,
  ...
  boots_image = new visual.ImageStim({
    ...
    image : 'creatures/shoes/boots-01.png', mask : undefined,
    ori : 0, pos : [(- 0.1), (- 0.05)], size : [0.3, (0.3 * 1.69)],
    color : new util.Color([1, 1, 1]), opacity : 1,
    flipHoriz : false, flipVert : false,
  ...
  redhouse = new visual.ImageStim({
    ...
    image : 'redhouse.png', mask : undefined,
  ...
  bluehouse = new visual.ImageStim({
    ...
    image : 'bluehouse.png', mask : undefined,
    ori : 0, pos : [0.65, 0], size : [(1.35 * 0.2), 0.2],
    color : new util.Color([1, 1, 1]), opacity : 1,
    flipHoriz : false, flipVert : false,
  ...
  bluehouse_correct = new visual.ImageStim({
    ...
    image : 'correct.png', mask : undefined,
  ...
  happy = new visual.ImageStim({
    ...
    image : 'happy.png', mask : undefined,
    ori : 0, pos : [0, 0], size : [0.5, 0.5],
    color : new util.Color([1, 1, 1]), opacity : 1,
    flipHoriz : false, flipVert : false,
...
function trialRoutineBegin(snapshot) {
  return async function () {
    ...
    ears_image.setImage(ears);
    tail_image.setImage(tail);
    shirt_image.setImage(shirt);
    sport_image.setImage(sport);
...
function feedbackRoutineBegin(snapshot) {
  return async function () {
    ...
    continueRoutine = true; // until we're told otherwise
    // update component parameters for each repeat
    scene_image_2.setImage(scene);
    ears_image_2.setImage(ears);
    tail_image_2.setImage(tail);
    shirt_image_2.setImage(shirt);
    sport_image_2.setImage(sport);
    if(answer === "redhouse") {
